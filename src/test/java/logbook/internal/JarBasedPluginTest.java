...
public class JarBasedPluginTest {
    ...
    public void test1() throws IOException {
        Path p = Paths.get("./src/test/resources/logbook/internal/plugin-test-case1.jar");
    ...
    public void testGetServices() throws IOException {
        ...
        {
            Path p = Paths.get("./src/test/resources/logbook/internal/plugin-test-case2.jar");
            JarBasedPlugin plugin = new JarBasedPlugin(p);
    ...
    public void testGetName() throws IOException {
        ...
        {
            Path p = Paths.get("./src/test/resources/logbook/internal/plugin-test-case3.jar");
            JarBasedPlugin plugin = new JarBasedPlugin(p);
        ...
        {
            Path p = Paths.get("./src/test/resources/logbook/internal/plugin-test-case4.jar");
            JarBasedPlugin plugin = new JarBasedPlugin(p);
            String expected = "";
            String actual = plugin.getName();
            assertEquals(expected, actual);
